...
(function() {
    ...
    Runner.sounds = {
        BUTTON_PRESS: 'online-sound-press',
        HIT: 'online-sound-hit',
        SCORE: 'online-sound-reached'
    };
    Runner.keycodes = {
        JUMP: {
            '38': 1,
    ...
    Runner.prototype = {
        ...
        loadImages: function() {
            if (IS_HIDPI) {
                Runner.imageSprite = document.getElementById('online-resources-2x');
                this.spriteDef = Runner.spriteDefinition.HDPI
            } else {
                Runner.imageSprite = document.getElementById('online-resources-1x');
        ...
        update: function() {
            var sb = document.getElementById("DinoWrap");
        ...
        gameOver: function() {
            ...
            var cscr = document.getElementById("HighScore");
            cscr.innerText = HighScore;
            var sb = document.getElementById("DinoWrap");
            ...
            if (this.distanceRan > this.highestScore) {
                ...
                HighScore = Math.round(this.highestScore * 0.025);
                cscr.innerText = HighScore;
                var score_d = 0;
                if (document.getElementById("score-5") !== null) {
                    score_d = document.getElementById("score-5").innerHTML
                }
                if (HighScore > score_d) {
                    var xhr = new XMLHttpRequest();
                    xhr.open('GET', '/inc/check.php?score=' + HighScore, false);
                    xhr.send();
                    if (xhr.status != 200) {} else {
                        if (xhr.responseText != '') {
                            ...
                            xhr.open('GET', '/inc/set.php?name=' + user_name + '&score=' + HighScore, false);
                            xhr.send();
                            //location.reload()
                        }
                    }
