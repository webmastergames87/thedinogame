/*Copyright (c) 2014 The Chromium Authors. All rights reserved. Use of this source code is governed by a BSD-style license that can be found in the LICENSE file.*/
        (function() {
            'use strict';
            const isMobile = !!navigator.userAgent.match(/AppleWebKit.*Mobile.*/) && !!navigator.userAgent.match(/AppleWebKit/);
            let adFlag = 0;
            if (!isMobile) { };
            ...
            Runner.prototype = {
                ...
                loadImages: function() {
                    if (IS_HIDPI) {
                        ...
                        Runner.bdayImageSprite = document.getElementById('offline-resources-bday-2x');
                        this.spriteDef = Runner.spriteDefinition.HDPI
                    } else {
                        Runner.imageSprite = document.getElementById('offline-resources-1x');
                        Runner.bdayImageSprite = document.getElementById('offline-resources-bday-1x');
                ...
                playIntro: function() {
                    if (!this.activated && !this.crashed) {
                        ...
                        customStyle.sheet.insertRule(keyframes, 0);
                ...
                update: function() {
                    ...
                    if (this.playing) {
                        ...
                        if (Runner.isBdayModeEnabled() && collision && this.horizon.obstacles[0].typeConfig.type == 'SNACK') {
                ...
                onKeyDown: function(e) {
                    ...
                    } else if (this.crashed && e.type == Runner.events.TOUCHSTART && e.currentTarget == this.containerEl) {
                        this.restart()
                    }
                },
                onKeyUp: function(e) {
            ...
            function checkForCollision(obstacle, tRex, opt_canvasCtx) {
                ...
                var tRexBox = new CollisionBox(tRex.xPos + 1, tRex.yPos + 1, tRex.config.WIDTH - 2, (tRex.bdayModeActive ? tRex.config.HEIGHT_BDAY : tRex.config.HEIGHT) - 2);
            ...
            function Obstacle(canvasCtx, type, spriteImgPos, dimensions, gapCoefficient, speed, opt_xOffset) {
                ...
                this.gap = 0;
                this.speedOffset = 0;
                this.imageSprite = this.typeConfig.type == 'SNACK' ? Runner.bdayImageSprite : Runner.imageSprite;
                this.currentFrame = 0;
                this.timer = 0;
                this.init(speed)
            };
            ...
            Obstacle.types = [{
                ...
                minGap: 999,
                minSpeed: 0,
                collisionBoxes: [new CollisionBox(0, 0, 40, 40)]
            }];
            ...
            Trex.prototype = {
                ...
                enableBdayMode: function(spritePos) {
                    ...
                    this.groundYPos = Runner.defaultDimensions.HEIGHT - this.config.HEIGHT - Runner.config.BOTTOM_PAD_BDAY;
                ...
                draw: function(x, y) {
                    ...
                    var sourceHeight = this.bdayModeActive ? this.config.HEIGHT_BDAY : this.config.HEIGHT;
                    ...
                    if (this.ducking && this.status != Trex.status.CRASHED) {
                        this.canvasCtx.drawImage(this.imageSprite, sourceX, sourceY, sourceWidth, sourceHeight, this.xPos, this.yPos, this.config.WIDTH_DUCK, outputHeight)
                    } else {
                        if (this.ducking && this.status == Trex.status.CRASHED) {
                            this.xPos++
                        }
                        this.canvasCtx.drawImage(this.imageSprite, sourceX, sourceY, sourceWidth, sourceHeight, this.xPos, this.yPos, this.config.WIDTH, outputHeight)
                    }
            ...
            Cloud.prototype = {
                ...
                draw: function() {
                    this.canvasCtx.save();
                    var sourceWidth = this.isBalloon ? Cloud.config.WIDTH_BALLOON : Cloud.config.WIDTH;
                    var sourceHeight = this.isBalloon ? Cloud.config.HEIGHT_BALLOON : Cloud.config.HEIGHT;
                    ...
                    this.canvasCtx.drawImage(this.imageSprite, this.spritePos.x, this.spritePos.y, sourceWidth, sourceHeight, this.xPos, this.yPos, outputWidth, outputHeight);
                    this.canvasCtx.restore()
                },
            ...
            Horizon.prototype = {
                ...
                addNewObstacle: function(currentSpeed) {
                    var obstacleCount = Runner.isBdayModeEnabled() && !this.bdayModeActive ? Obstacle.types.length - 1 : Obstacle.types.length - 2;
                ...
                addCloud: function() {
                    var cloudType = this.bdayModeActive && getRandomNum(0, 1) > 0 ? this.spritePos.BALLOON : this.spritePos.CLOUD;
                    this.clouds.push(new Cloud(this.canvas, cloudType, this.dimensions.WIDTH, cloudType == this.spritePos.BALLOON))
                }
            }
        })();
